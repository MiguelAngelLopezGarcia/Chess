...
class Wellcome
    ...
    def wellcome_in_english
        ...
        puts "When a piece is attacked it's background will be colored in red #{attacked_pawn}"
    ...
    def wellcome_in_spanish
        ...
        puts "Cuando una pieza sea atacada su fondo cambiará a rojo #{attacked_pawn}"
